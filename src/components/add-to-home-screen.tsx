...
const AddToIosSafari = dynamic(() => import('./add-to-ios-safari'), { loading: () => <ModuleLoading /> });
const AddToMobileChrome = dynamic(() => import('./add-to-mobile-chrome'), { loading: () => <ModuleLoading /> });
const AddToMobileFirefox = dynamic(() => import('./add-to-mobile-firefox'), { loading: () => <ModuleLoading /> });
const AddToMobileFirefoxIos = dynamic(() => import('./add-to-mobile-firefox-ios'), { loading: () => <ModuleLoading /> });
const AddToMobileChromeIos = dynamic(() => import('./add-to-mobile-chrome-ios'), { loading: () => <ModuleLoading /> });
const AddToSamsung = dynamic(() => import('./add-to-samsung'), { loading: () => <ModuleLoading /> });
const AddToOtherBrowser = dynamic(() => import('./add-to-other-browser'), { loading: () => <ModuleLoading /> });
